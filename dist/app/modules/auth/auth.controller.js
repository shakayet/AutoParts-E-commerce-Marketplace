...
const registerUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.registerUserFromDB(userData);
    (0, sendResponse_1.default)(res, {
        success: true,
...
const refreshToken = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const tokenData = __rest(req.body, []);
    const result = yield auth_service_1.AuthService.refreshTokenToDB(tokenData);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const logout = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const tokenData = __rest(req.body, []);
    yield auth_service_1.AuthService.logoutFromDB(tokenData);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
