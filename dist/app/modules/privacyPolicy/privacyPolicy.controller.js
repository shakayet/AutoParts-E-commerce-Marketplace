...
const createPrivacyPolicy = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield privacyPolicy_service_1.PrivacyPolicyService.createPrivacyPolicyToDB(req.body);
...
const updatePrivacyPolicy = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield privacyPolicy_service_1.PrivacyPolicyService.updatePrivacyPolicyToDB(id, req.body);
    (0, sendResponse_1.default)(res, {
        success: true,
...
const deletePrivacyPolicy = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield privacyPolicy_service_1.PrivacyPolicyService.deletePrivacyPolicyFromDB(id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const getPrivacyPolicies = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield privacyPolicy_service_1.PrivacyPolicyService.getPrivacyPoliciesFromDB();
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
